...
# SparkML
SparkMLを用いると簡単に機械学習のアルゴリズムを使うことができます。  
特段、Sparkをシステムにインストール必要がなく、感覚としては、scikit-learnなどの利用間に近いです。

## SparkMLでLogisticRegression  
...
### まとめ
１. DataOperation(標準のデータ構造)を用いてほぼすべての表現が可能なことを示しました
